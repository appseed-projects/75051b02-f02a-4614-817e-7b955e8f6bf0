...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-12-24 15:32`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/75051b02-f02a-4614-817e-7b955e8f6bf0.git
$ cd 75051b02-f02a-4614-817e-7b955e8f6bf0
```
